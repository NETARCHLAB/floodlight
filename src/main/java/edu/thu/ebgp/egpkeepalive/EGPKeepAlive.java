...
public class EGPKeepAlive implements IFloodlightModule, IOFMessageListener,
		IOFSwitchListener ,IFloodlightService{
	...
	protected static IGatherService gather;
	...
	public static void onGatherMessage(String fromAS,String message){
		gather.onMessage(fromAS, message);
	}
