...
public class TraceRouteMultiTable implements IFloodlightModule,
	...
	public void switchAdded(DatapathId switchId) {
		...
		if (switchId.equals(DatapathId.of("00:00:00:00:00:00:00:05")))
			createFlowMods(switchId.toString(), "10.0.2.2", OFPort.CONTROLLER, 2);
		else
			createFlowMods(switchId.toString(), "10.0.2.2", OFPort.of(2), 0);
	...
	public void init(FloodlightModuleContext context)
		...
		logger = LoggerFactory.getLogger("traceroutetest.TraceRouteMultiTable");
	}
	...
	public static void createFlowMods(String switchid, String dstipv4, OFPort outport, int option){
		...
		if (option == 2){
			...
			if (tableid == 1){
				...
				myMatchBuilder.setExact(MatchField.ETH_TYPE, EthType.IPv4);
				myMatchBuilder.setMasked(MatchField.IPV4_DST, IPv4AddressWithMask.of(dstipv4));
				myMatchBuilder.setExact(MatchField.ETH_DST, MacAddress.of("00:00:00:00:00:02"));
				Match myMatch = myMatchBuilder.build();
